...
function DeleteAccountComponent() {
  return (
    <DeleteStyle.Container>
        ...
        <DeleteStyle.Form><DeleteStyle.Wrapper>
          ...
          <DeleteStyle.LastDescription>
            회원님! 탈퇴 후 3개월 동안은 회원가입이 불가능합니다. 탈퇴한
            아이디는 본인과 타인 모두 재사용 및 복구가 불가하오니 신중하게
            선택해 주시길 바랍니다.
          </DeleteStyle.LastDescription>
          <DeleteStyle.ButtonWrap>
          <DeleteStyle.PressButton>
            <DeleteStyle.BackLink to="/">취소하기</DeleteStyle.BackLink>
          </DeleteStyle.PressButton>
          <DeleteStyle.PressButton>
            <DeleteStyle.RemoveLink to="/">
              회원 탈퇴하기
            </DeleteStyle.RemoveLink>
          </DeleteStyle.PressButton></DeleteStyle.ButtonWrap>
        </DeleteStyle.Form>
