...
const BcBox3 = () => {
  ...
  useEffect(() => {
    ...
    const url = `http://www.aladin.co.kr/ttb/api/ItemList.aspx?ttbkey=${process.env.REACT_APP_ALADIN_SECRET_KEY}&QueryType=Bestseller&MaxResults=2&start=4&SearchTarget=Book&output=js&Version=20131101&callback=${callbackName}`;
